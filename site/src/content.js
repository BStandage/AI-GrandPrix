...
export const site = {
  title: "Eleven Flights, Zero Gates",
  subtitle: "Our week at the AI Grand Prix, September 2026",
  tagline:
    "3,300 teams entered. We finished in the top 15, flew an autonomy stack we built from nothing since June, and never got through a single gate. This is the whole story, the good parts and the bad, computed from the flight logs and the commit history.",
...
export const stats = [
  ...
  { value: "14", label: "autonomous course flights" },
  { value: "7", label: "attempts in the final slot" },
  { value: "0", label: "gates" },
  { value: "220", label: "commits on main" },
];
...
export const timeline = [
  ...
  {
    date: "After",
    title: "Ten teams advanced. We were not one of them.",
    body: [
      "Top 15 of 3,300 is a real result, and it does not feel like one when four gates was the line and attempt 6 was on the centre line at three and a half metres out.",
