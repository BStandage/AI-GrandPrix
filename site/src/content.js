...
export const team = {
  ...
  members: [
    { name: "Brian Standage", role: ["Team Lead", "AI/ML Engineer"], photo: "photos/team/brian.jpeg", blurb: "Software lead: the software architecture, the perception and machine-learning work, and the autonomy stack from the first commit to the race-day build.", linkedin: "https://www.linkedin.com/in/brian-standage-22835912a/" },
    { name: "Cristhian Prado", role: "AI/ML Engineer", photo: "photos/team/cristhian.jpg", blurb: "Software development, debugging and decision-making between flights, and the support that kept the effort moving. Ran the project on the ground: project management, time keeping against the slot clock, debrief logging after every flight, and progress tracking across the three days.", linkedin: "https://www.linkedin.com/in/pradocristhian/" },
    { name: "Reese Haven", role: "Electrical Engineer", photo: "photos/team/reese.jpg", blurb: "Betaflight and drone subject-matter expert: propeller assembly, drone repair, and the flight controller setup. Manned the transmitter for every flight and saved the aircraft with a manual landing several times. Plugged in, armed and set the drone on the course before each attempt.", linkedin: "https://www.linkedin.com/in/reese-haven-6a57a1224/" },
  ],
