...
export const site = {
  ...
  tagline:
    "Between June and September 2026 we built a complete autonomy stack for the AI Grand Prix: gate perception, vision-aided state estimation, trajectory planning, a flight controller interface, and a Betaflight software-in-the-loop simulator. The physical qualifier in Costa Mesa was the first time the software ran on the competition aircraft. This report documents each subsystem, the hardware bring-up, fourteen autonomous course flights with their logs, and the analysis of what failed.",
};
...
export const team = {
  intro:
    "I built the autonomy stack and the simulator on my own from June. There were two virtual qualifiers: I qualified through VQ1, then placed in the top 15 of more than 3,300 teams worldwide in VQ2, which earned an invitation to the physical qualifiers. My teammates Cristhian Prado and Reese Haven joined me for the physical qualifier at Anduril in Costa Mesa, CA. [BRIAN: one line on where you're from, if you want it.]",
  members: [
