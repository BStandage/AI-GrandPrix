...
export const team = {
  ...
  members: [
    { name: "Brian Standage", role: ["Team Lead", "AI/ML Engineer"], photo: "photos/team/brian.jpeg", blurb: "Software lead. Designed the architecture and wrote the autonomy stack: perception and ML, state estimation, planning, control, the flight controller interface, and the simulator work. On site: brought the aircraft up, synced every build to the drones, wrote and ran every flight, pulled and analysed every log, and changed the code between attempts.", linkedin: "https://www.linkedin.com/in/brian-standage-22835912a/" },
    { name: "Cristhian Prado", role: "AI/ML Engineer", photo: "photos/team/cristhian.jpg", blurb: "Software development and debugging support, and input on the decisions between flights. Ran the project on the ground: project management, time keeping against the slot clock, debrief logging after every flight, and progress tracking across the three days.", linkedin: "https://www.linkedin.com/in/pradocristhian/" },
