...
export const team = {
  intro:
    "The two virtual qualifiers were flown in the organizers' simulator, with our stack connected to it over MAVLink: I qualified through VQ1, then placed in the top 15 of more than 3,300 teams worldwide in VQ2, which earned an invitation to the physical qualifiers. Cristhian Prado and Reese Haven joined the team for the physical qualifier at Anduril in Costa Mesa, CA. To prepare, we forked an open-source Elodin drone simulator that runs the Betaflight flight-controller firmware in the loop and built the published course into it, so the same code could be developed against the real course before it ever flew.",
  members: [
    ...
    { name: "Cristhian Prado", role: "AI/ML Engineer", photo: "photos/team/cristhian.jpg", blurb: "Software development, perception support and debugging, and input on the decisions between flights. Ran the project on the ground: project management, time keeping against the slot clock, debrief logging after every flight, and progress tracking across the three days.", linkedin: "https://www.linkedin.com/in/pradocristhian/" },
