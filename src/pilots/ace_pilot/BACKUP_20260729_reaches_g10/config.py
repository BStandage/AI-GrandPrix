...
ACE_V_MAX        = 7.5 # cruise ceiling (m/s); measured terminal is ~29-31
...
ACE_A_LAT        = 6.0 # max lateral (centripetal) accel (m/s^2); measured ceiling 9.8/axis. 6.0 = 31 deg bank vs the 45 deg clamp. 7.5 was tried and made the profile worse (the limiter was not the binding constraint - a near-stop at s=167 was).
ACE_A_ACC        = 3.4     # max along-track acceleration (m/s^2)
