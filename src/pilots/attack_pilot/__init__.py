"""Attack pilot: fighter-pilot bearing servo. Course-adaptive, reactive, no hardcoded line.
...
from .attack_pilot import update_attack_control

__all__ = ["update_attack_control"]
